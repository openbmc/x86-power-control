...
static constexpr std::string_view getOperatingSystemStateStage(const OperatingSystemStateStage stage)
{
    switch (stage)
    {
...
static void setOperatingSystemState(const OperatingSystemStateStage stage)
{
    ...
    std::string logMsg =
        "Moving os state to " + std::string(getOperatingSystemStateStage(stage)) + " stage.\n";
...
int main(int argc, char* argv[])
{
    ...
    static OperatingSystemStateStage osState;
    if (postCompleteConfig.type == ConfigType::GPIO)
    {
    ...
    osIface->register_property("OperatingSystemState",
